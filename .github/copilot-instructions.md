<!-- Copilot instructions for the FUAM to FCA Bridge migration project -->

# Project: FUAM to FCA Bridge Migration

Automated migration of FUAM artifacts to FCA Bridge format.
...
- **Target / Generation**: `deployed_report/`, `_deployed_report/`
