---
description: "Shared rules for all agents in the FUAM to FCA Bridge migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — FUAM to FCA Bridge Migration
...
- **Source**: `src/`
- **Target**: `deployed_report/`, `_deployed_report/`
- **Tests**: `tests/`
- **Docs**: `docs/`
