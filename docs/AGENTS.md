# Multi-Agent Architecture — FUAM to FCA Bridge Migration
...
| **@extractor** | Parsing FUAM source artifacts | `src/` extraction modules |
...
| **@generator** | Cross-cutting generation coordination | `deployed_report/`, `_deployed_report/` generators |
...
| **Formula Correctness** | Valid syntax, correct conversion from FUAM formulas |
