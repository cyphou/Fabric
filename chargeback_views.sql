...
--
-- VIEWS:
--   1. v_CapacityCostPeriod          — Daily cost per capacity (amortized)
--   2. v_WorkspacesCUConsumption     — CU share per workspace per day
--   3. v_FabricCostSplitByWorkspace  — Final chargeback output
--   4. v_ReservationSavingsSummary   — Reservation ROI analysis
--
-- PREREQUISITES:
--   Create 3 OneLake shortcuts in the FCA Lakehouse before running:
--     FUAM_capacities, FUAM_workspaces, FUAM_capacity_metrics_by_item_kind_by_day
--   See README.md for full deployment instructions.
--
-- USAGE:
--   Run this entire script once in the FCA Lakehouse SQL analytics endpoint.
